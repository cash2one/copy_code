$(function(){
    ...
    base.data_conn('get_ad_position','',adPosition,'get');
    ...
    base.data_conn('ad_daily',formdata,getData,'get');
    $('.qudao').change(function(){
        formdata.platform=MultiSelect($('.qudao>option')).substring(0, MultiSelect($('.qudao>option')).length - 1);
        qudaodata.ctype=MultiSelect($('.qudao>option')).substring(0, MultiSelect($('.qudao>option')).length - 1);console.log("aaa"+qudaodata.ctype)
        qudaodata2.ptype=MultiSelect($('.ptype>option')).substring(0, MultiSelect($('.ptype>option')).length - 1);
